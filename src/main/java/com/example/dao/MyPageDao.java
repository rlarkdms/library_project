...
public class MyPageDao {
	...
	List<Return_List> results = jdbcTemplate.query(("select book.book_id,book.book_name,borrow_list.book_return_date,extend_confirm from borrow_list Inner join book on borrow_list.book_id=book.book_id where borrow_list.member_id='"+member_id+"';"),
